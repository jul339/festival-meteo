...
class SIBILExtractor:
    ...
    def extract_SIBIL_filtered(
        ...
        Schéma du DataFrame:                                                            
root
 |-- declaration_creation: string (nullable = true)
 |-- declaration_modification: string (nullable = true)
 |-- declarant_ID_sibil: string (nullable = true)
 |-- declarant_nom: string (nullable = true)
 |-- declarant_nom_usuel: string (nullable = true)
 |-- declarant_statut: string (nullable = true)
 |-- demandeur_ID_sibil: integer (nullable = true)
 |-- demandeur_role: string (nullable = true)
 |-- declarant_siret: string (nullable = true)
 |-- declarant_code_postal: string (nullable = true)
 |-- declarant_ville: string (nullable = true)
 |-- declarant_departement: string (nullable = true)
 |-- declarant_region: string (nullable = true)
 |-- declarant_numero_dossier: string (nullable = true)
 |-- declarant_numero_licence: string (nullable = true)
 |-- declaration_ID_sibil: integer (nullable = true)
 |-- declaration_ID_externe: string (nullable = true)
 |-- declaration_date_representation: string (nullable = true)
 |-- declaration_statut: string (nullable = true)
 |-- declaration_cause_erreur: string (nullable = true)
 |-- declaration_gestionnaires_multiples: boolean (nullable = true)
 |-- festival_ID_parent_sibil: integer (nullable = true)
 |-- festival_nom_parent: string (nullable = true)
 |-- festival_ID_sibil: integer (nullable = true)
 |-- festival_nom: string (nullable = true)
 |-- festival_ville: string (nullable = true)
 |-- festival_code_postal: integer (nullable = true)
 |-- festival_date_creation: string (nullable = true)
 |-- festival_statut: string (nullable = true)
 |-- festival_contributeur_ID_sibil: integer (nullable = true)
 |-- festival_validateur_ID_sibil: integer (nullable = true)
 |-- festival_cause_erreur_adresse: string (nullable = true)
 |-- lieu_ID_parent_sibil: integer (nullable = true)
 |-- lieu_nom_parent: string (nullable = true)
 |-- lieu_ID_sibil: integer (nullable = true)
 |-- lieu_nom: string (nullable = true)
 |-- lieu_nom_usuel: string (nullable = true)
 |-- lieu_adresse: string (nullable = true)
 |-- lieu_code_postal: string (nullable = true)
 |-- lieu_ville: string (nullable = true)
 |-- lieu_siret: long (nullable = true)
 |-- lieu_departement_code: integer (nullable = true)
 |-- lieu_departement_nom: string (nullable = true)
 |-- lieu_date_creation: string (nullable = true)
 |-- lieu_statut: string (nullable = true)
 |-- lieu_contributeur_ID_sibil: integer (nullable = true)
 |-- lieu_validateur_ID_sibil: integer (nullable = true)
 |-- lieu_cause_erreur_adresse: string (nullable = true)
        """
        schema = StructType([
